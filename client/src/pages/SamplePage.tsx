...
export default function SamplePage() {
    ...
    return (
        <div
            className="bg-[#EEE9DF] w-full flex flex-col items-center p-3 xs:p-4 md:p-0 min-h-screen"
        >
                ...
                <div className="w-full max-w-4xl flex items-center justify-center px-3 xs:px-4 sm:px-4 mb-2 xs:mb-3 sm:mb-4 relative">
                    ...
                    <div className="flex bg-white/50 rounded-full p-0.5 xs:p-1 sm:p-1 shadow-sm backdrop-blur-sm z-10">
                        <button
                            ...
                            className={`px-3 py-1.5 xs:px-4 xs:py-2 sm:px-6 sm:py-2 rounded-full text-xs xs:text-sm font-semibold transition-all duration-300 ${activeTab === "read"
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 xs:px-4 xs:py-2 sm:px-6 sm:py-2 rounded-full text-xs xs:text-sm font-semibold transition-all duration-300 ${activeTab === "listen"
                                ? "bg-[#1B2632] text-white shadow-md"
                                : "text-[#1B2632]/70 hover:bg-white/50"
                                }`}
                        >
            ...
            {/* Main Content */}
            <div className={`w-full max-w-7xl flex flex-col items-center justify-center flex-1 ${activeTab === "listen" ? "min-h-[calc(100dvh-8rem)] overflow-hidden" : "mb-8"
                }`}>
                {activeTab === "read" ? (
                    <div key="read" className="w-full animate-in slide-in-from-left duration-500 ease-in-out flex flex-col items-center">
                    ...
                    <div key="listen" className="w-full animate-in slide-in-from-right duration-500 ease-in-out flex flex-col items-center justify-center px-0">
            ...
            <section className="w-full px-3 xs:px-4 sm:px-6 py-6 xs:py-8 sm:py-10 bg-[#EEE9DF]">
                ...
                <ul className="list-none max-w-md mx-auto space-y-2.5 xs:space-y-3 sm:space-y-3.5 text-[#1B2632]/90 text-xs xs:text-sm sm:text-base font-['Outfit']">
                    <li className="flex gap-2.5 xs:gap-3 items-start">
                        <span className="text-[#A35139] mt-0.5 shrink-0" aria-hidden>•</span>
