...
export default function CreateAlbum() {
    ...
    const onSubmit = async (data: CreateAlbumFormValues) => {
        ...
        try {
            ...
            const validQuestions = data.questions?.filter(q => q.text.trim().length > 0);
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input {...field} placeholder="My Family Album" className="h-11 bg-white" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    ...
                                                    <Input {...field} placeholder="you@example.com" className="h-11 pl-10 bg-white" />
                                                </div>
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem className="flex-1">
                                                            <FormControl>
                                                                <Input {...field} placeholder={`Question ${index + 1}`} className="h-10 bg-white" />
                                                            </FormControl>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
