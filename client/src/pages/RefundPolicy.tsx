                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <section className="mb-8">
                        ...
                        <ul className="list- pl-6 mb-4 text-muted-foreground space-y-2">
                            <li>
                                the issue arises solely from Kahani’s delivery of the
                                offering and materially prevents its intended use;
                            </li>
                            <li>
                                the issue remains unresolved despite reasonable corrective
                                or support measures;
                            </li>
                            <li>
                            ...
                            <li>
                                the user has not meaningfully accessed, consumed, or
                                otherwise derived benefit from the offering.
                            </li>
                        </ul>
                        <h3 className="text-xl font-semibold mb-2 text-foreground">
