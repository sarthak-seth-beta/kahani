...
export function ProductSelection({ albumId, onContinue }: ProductSelectionProps) {
                        ...
                        >
                            ...
                            <div className="flex-1 space-y-1">
                                <div className="flex items-center justify-between">
                                    <span className={cn("font-bold text-[#1B2632]", isSelected ? "text-[#A35139]" : "")}>
                                        {product.title}
                                    </span>
                                    <span className="font-bold text-[#1B2632]">{product.price}</span>
                                </div>
